...
export function LegalDocumentPreview({
  ...
  return (
    <div className="ds-paper-texture flex h-full min-h-[560px] w-full max-w-2xl flex-col overflow-hidden rounded-lg">
      <div className="relative z-10 flex h-full flex-col pl-16 pr-8 pb-10 pt-10 md:pl-24 md:pr-12 md:pt-12">
        <header className="mb-8 flex shrink-0 items-end justify-between border-b border-slate-200 pb-6">
          <div className="min-w-0 flex-1 pr-4">
            <p className="mb-1 text-[10px] font-bold uppercase tracking-widest text-fuchsia-600">
              {contract.campaignName}
            </p>
            <h1 className="font-doc-title text-xl font-bold leading-tight text-slate-900 md:text-2xl">
              {contract.documentTitle || 'Documento'}
            </h1>
          ...
          <div className="shrink-0 text-right">
            <img
              src={logoAgency}
              alt="Agency"
              className="ml-auto mb-2 h-12 w-12 rounded-xl object-contain shadow-sm ring-1 ring-slate-100"
            />
            <p className="text-[10px] font-mono text-slate-500">
              Emitido: <span className="font-bold text-slate-800">{issuedDate}</span>
            </p>
          </div>
        </header>
        ...
        <footer className="relative mt-6 grid shrink-0 grid-cols-2 gap-6 pt-8 md:gap-8">
          <div>
            <p className="mb-6 text-[10px] font-bold uppercase tracking-wider text-slate-400">
              Firma Parte A
            </p>
            ...
            <div className="mt-1 flex items-center gap-1">
              ...
              <p className="text-[9px] font-mono uppercase text-slate-500">
                {isSealed ? 'Firmado digitalmente' : 'Pendiente de firma'}
              </p>
            </div>
          </div>
          ...
          <div className={cn(!contract.partyBPreApproved && 'opacity-70')}>
            ...
            <div className="mt-1 flex items-center gap-1">
              ...
              />
              <p className="text-[9px] font-mono uppercase text-slate-500">
                {contract.partyBPreApproved ? 'Pre-aprobado' : 'Pendiente'}
              </p>
            </div>
          </div>
          ...
          <div
            className={cn(
              'pointer-events-none absolute right-0 top-0 origin-center -translate-y-1/2 transform',
              showSeal ? 'ds-stamp-animation opacity-100' : 'opacity-0',
            )}
          >
            <div className="relative flex h-28 w-28 items-center justify-center rounded-full border-[3px] border-fuchsia-600 bg-white/90 backdrop-blur-sm md:h-32 md:w-32">
              <div className="absolute inset-2 rounded-full border border-dashed border-fuchsia-500/50" />
              <div className="text-center">
                <CheckCircle2 className="mx-auto mb-1 h-7 w-7 text-fuchsia-600" />
